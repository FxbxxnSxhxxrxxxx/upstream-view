...
$p_schaetzung = $_DELETE['schaetzung'];
...
$pdf->Cell(0,5,'',0,1,'C');
$pdf->SetFont("Arial","",12);
$pdf->Cell(47.5,5,round($p_schaetzung / $_DELETE['anzahlAktien'],2),1,0,'C'); $pdf->Cell(47.5,5,round($p_gesamtertragswert / $_DELETE['anzahlAktien'],2),1,0,'C'); $pdf->Cell(47.5,5,round(($p_gesamtertragswert+$p_schaetzung) / $_DELETE['anzahlAktien'],2),1,0,'C');
