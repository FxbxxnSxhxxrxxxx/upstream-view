...
$p_umsatz[3] = $_DELETE['umsatz3'];
$p_umsatz[4] = $_DELETE['umsatz4'];
...
$p_abschreibungen[3] = $_DELETE['abschreibungen3'];
$p_abschreibungen[4] = $_DELETE['abschreibungen4'];
$p_ebit[0] = $_DELETE['ebit0'];
$p_ebit[1] = $_DELETE['ebit1'];
$p_ebit[2] = $_DELETE['ebit2'];
$p_ebit[3] = $_DELETE['ebit3'];
$p_ebit[4] = $_DELETE['ebit4'];
...
$p_zinsaufwendungen[3] = $_DELETE['zinsaufwendungen3'];
$p_zinsaufwendungen[4] = $_DELETE['zinsaufwendungen4'];
$p_steuern[0] = $_DELETE['steuern0'];
$p_steuern[1] = $_DELETE['steuern1'];
$p_steuern[2] = $_DELETE['steuern2'];
$p_steuern[3] = $_DELETE['steuern3'];
$p_steuern[4] = $_DELETE['steuern4'];
...
$p_anlagevermoegen[3] = $_DELETE['anlagevermoegen3'];
$p_anlagevermoegen[4] = $_DELETE['anlagevermoegen4'];
$p_sachanlagen[0] = $_DELETE['sachanlagen0'];
$p_sachanlagen[1] = $_DELETE['sachanlagen1'];
$p_sachanlagen[2] = $_DELETE['sachanlagen2'];
$p_sachanlagen[3] = $_DELETE['sachanlagen3'];
$p_sachanlagen[4] = $_DELETE['sachanlagen4'];
$p_goodwill[0] = $_DELETE['goodwill0'];
$p_goodwill[1] = $_DELETE['goodwill1'];
$p_goodwill[2] = $_DELETE['goodwill2'];
$p_goodwill[3] = $_DELETE['goodwill3'];
$p_goodwill[4] = $_DELETE['goodwill4'];
...
$p_immaterielleVermoegensw[3] = $_DELETE['immaterielleVermoegensw3'];
$p_immaterielleVermoegensw[4] = $_DELETE['immaterielleVermoegensw4'];
$p_finanzanlagen[0] = $_DELETE['finanzanlagen0'];
$p_finanzanlagen[1] = $_DELETE['finanzanlagen1'];
$p_finanzanlagen[2] = $_DELETE['finanzanlagen2'];
$p_finanzanlagen[3] = $_DELETE['finanzanlagen3'];
$p_finanzanlagen[4] = $_DELETE['finanzanlagen4'];
$p_liquideMittel[0] = $_DELETE['liquideMittel0'];
$p_liquideMittel[1] = $_DELETE['liquideMittel1'];
$p_liquideMittel[2] = $_DELETE['liquideMittel2'];
$p_liquideMittel[3] = $_DELETE['liquideMittel3'];
$p_liquideMittel[4] = $_DELETE['liquideMittel4'];
$p_vorraete[0] = $_DELETE['vorraete0'];
$p_vorraete[1] = $_DELETE['vorraete1'];
$p_vorraete[2] = $_DELETE['vorraete2'];
$p_vorraete[3] = $_DELETE['vorraete3'];
$p_vorraete[4] = $_DELETE['vorraete4'];
...
$p_forderungenLuL[3] = $_DELETE['forderungenLuL3'];
$p_forderungenLuL[4] = $_DELETE['forderungenLuL4'];
...
$p_verbindlichkeitenLuL[3] = $_DELETE['verbindlichkeitenLuL3'];
$p_verbindlichkeitenLuL[4] = $_DELETE['verbindlichkeitenLuL4'];
...
$p_cashflowOperativ[3] = $_DELETE['operaCashFlow3'];
$p_cashflowOperativ[4] = $_DELETE['operaCashFlow4'];
...
$p_cashflowInvestiv[3] = $_DELETE['investCashFlow3'];
$p_cashflowInvestiv[4] = $_DELETE['investCashFlow4'];
...
$p_dividende_rueckkauf[3] = $_DELETE['dividende_rueckkauf3'];
$p_dividende_rueckkauf[4] = $_DELETE['dividende_rueckkauf4'];
