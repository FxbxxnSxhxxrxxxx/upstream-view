...
$p_kurzfrVerbind[3] = $_PUT['kurzfrVerbind3'];
$p_kurzfrVerbind[4] = $_PUT['kurzfrVerbind4'];
$p_langfrVerbind[0] = $_PUT['langfrVerbind0'];
$p_langfrVerbind[1] = $_PUT['langfrVerbind1'];
$p_langfrVerbind[2] = $_PUT['langfrVerbind2'];
$p_langfrVerbind[3] = $_PUT['langfrVerbind3'];
$p_langfrVerbind[4] = $_PUT['langfrVerbind4'];
...
$p_sachanlagen[3] = $_PUT['sachanlagen3'];
$p_sachanlagen[4] = $_PUT['sachanlagen4'];
$p_goodwill[0] = $_PUT['goodwill0'];
$p_goodwill[1] = $_PUT['goodwill1'];
$p_goodwill[2] = $_PUT['goodwill2'];
$p_goodwill[3] = $_PUT['goodwill3'];
$p_goodwill[4] = $_PUT['goodwill4'];
...
$p_immaterielleVermoegensw[3] = $_PUT['immaterielleVermoegensw3'];
$p_immaterielleVermoegensw[4] = $_PUT['immaterielleVermoegensw4'];
$p_finanzanlagen[0] = $_PUT['finanzanlagen0'];
$p_finanzanlagen[1] = $_PUT['finanzanlagen1'];
$p_finanzanlagen[2] = $_PUT['finanzanlagen2'];
$p_finanzanlagen[3] = $_PUT['finanzanlagen3'];
$p_finanzanlagen[4] = $_PUT['finanzanlagen4'];
$p_liquideMittel[0] = $_PUT['liquideMittel0'];
$p_liquideMittel[1] = $_PUT['liquideMittel1'];
$p_liquideMittel[2] = $_PUT['liquideMittel2'];
$p_liquideMittel[3] = $_PUT['liquideMittel3'];
$p_liquideMittel[4] = $_PUT['liquideMittel4'];
...
$p_dividende_rueckkauf[3] = $_PUT['dividende_rueckkauf3'];
$p_dividende_rueckkauf[4] = $_PUT['dividende_rueckkauf4'];
